@Test_Hafaka_Muzarim
Feature: Test hafakat mizrim risk1 risk5 nehut keren or top
  ...
  Scenario: page 156319
    ...
    Then I_send_number_product "2"
    And I_send_insurance_sum1
    Then I_click_shmor_button 
    Then I_send_number_product "3"
    And I_send_insurance_sum2
    Then I_click_shmor_button
    Then I_send_number_product "4"
    And I_send_insurance_sum3
