@Test_Hafaka_Havila 
Feature: Test hafaka havila 240 teunot top
  ...
  Scenario: page 156319
    Then I_send_number_product "7"
    Then I_choose_pizui_hodshi
    Then I_choose_tkufat_amtana
    Then I_choose_tkufat_tashlum
    Then I_click_shmor_button
    Then I_send_mispar_havila
    Then I_mark_check_box_havila
    Then I_choose_shum_bituah
    Then I_choose_azara_mugbelet
  ...
  Scenario: page 115402 - סימולציה
    ...
    Then I_click_on_plato_briut_button
