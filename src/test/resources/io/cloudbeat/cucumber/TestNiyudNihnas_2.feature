@Test_Niyud_Nihnas_2 
Feature: Test hafaka Niyud Nihnas menaalim, Status 9074, 9075 + parametr halukat hisahon pensioni
 ...
 Scenario: page 117305 - מסך תקציב -   
   ...
   Then I_choose_afik
   Then I_click_on_drop_down_button
   Then I_click_on_drop_down_button
   Then I_choose_halukat_hisahon_pensioni
   Then I_click_on_next_button_to_all_page 
   Then I_click_on_maslul_hashkaa_button  
    ...
    Then I_enter_ahuz_hashkaa1
    Then I_click_on_drop_down_button
    Then I_choose_halukat_hisahon_pensioni1
    Then I_click_on_next_button_to_all_page
