#Author: alexeim@menoramivt.co.il
@Test_Niyud_Nihnas_Mevutah_Kayam
Feature: Test hafaka Niyud Nihnas menaalim, Status 9074, 9075
  ...
  Scenario: page 115208 - הצעת ביטוח -
    ...
    Then I_enter_id_number_kayam
    Then I_mark_tik_hadash_check_box
  ...
  Scenario: page 120512 - חוצץ מבוטחים -
    Then I_write_all_data_page_mevutah_kayam_120512
    Then I_click_on_next_button_to_all_page
